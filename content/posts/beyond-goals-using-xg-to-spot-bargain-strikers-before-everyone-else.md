...
*League games from 2014/15 – 2019/20*  
*Source: https://www.messivsronaldo.app/detailed-stats/xg-expected-goals/*

---

For now, let's ignore that differential and look purely at *xG*. The top two in xG are **Cristiano Ronaldo** and **Robert Lewandowski**. However, one has a differential of +5.9 and the other -6.52. Both are just narrowly around their xG marks. This doesn't mean they are not the natural finishers we expect them to be.

Looking at goals, we can see that the bottom 3 goal scorers overachieved by 10 goals each, whilst the 3rd highest goal scorer, Robert Lewandowski, underachieved by -6.52 goals.  
**This is to say that the best goal scorers aren't the ones overachieving their xG (unless you're Messi, in which case logic doesn't apply), they are the ones creating the highest xG.**
...
So, to finish our earlier example:  
**Player B is the smart, economical, and correct sporting decision.**
